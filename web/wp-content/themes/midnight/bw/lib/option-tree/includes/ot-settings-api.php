              ...
              echo '<div id="option-tree-settings-api">';
                ...
                if ( isset( $page['sections'] ) && count( $page['sections'] ) > 0 ) {
                  ...
                  foreach( (array) $page['sections'] as $section ) {
                    echo '<li id="tab_' . $section['id'] . '"><a class="' . (!empty($section['icon']) ? 'has-icon' : '') . '" href="#section_' . $section['id'] . '">' . ( !empty( $section['icon'] ) ? '<i class="fa ' . $section['icon'] . '"></i>' : '' ) . '' . $section['title'] . '</a></li>';
                  }
          ...
          echo '<div class="format-setting-wrap">';
            ...
            if ( $field['args']['type'] != 'textblock' && ! empty( $field['title'] ) ) {
              ...
              echo '<div class="format-setting-label">';
                ...
                if( $field['args']['type'] !== 'bw-text-content' and isset($field['args']['desc']) ) {
					echo '<p class="sub-desc">' . $field['args']['desc'] . '</p>';  
				}
