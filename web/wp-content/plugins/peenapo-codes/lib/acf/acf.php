...
class acf
{
	...
	*/
	...
	function include_before_theme()
	{
		...
		include_once('core/fields/number_slider.php');
	...
	*/
	...
	function admin_menu()
	{
		add_menu_page(__("Custom Fields",'acf'), __("Custom Fields",'acf'), 'manage_options', 'edit.php?post_type=acf', false, false, '61.025');
	}
