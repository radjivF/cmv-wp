	...
	*/
	...
	acf.conditional_logic = {
		...
		calculate : function( rule, $toggle, $target ){
			...
			// compare values
			if( $toggle.hasClass('field_type-true_false') || $toggle.hasClass('field_type-checkbox') || $toggle.hasClass('field_type-radio') || $toggle.hasClass('field_type-radio_image') )
			{
