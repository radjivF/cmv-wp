...
class acf_field_number_slider extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->label = __("Number Slider",'acf');
		$this->defaults = array(
			'default_value'	=>	'',
			'min'			=>	'',
			'max'			=>	'',
	...
	*/
	...
	function create_field( $field )
	{
		...
		$e .= '<div class="slider-wrapper acf-input-wrap acf-slider-wrap">';
		$e .= '<span class="acf-slider-label">' . ( $field['prepend'] ? $field['prepend'] . ' ' : '' ) . '<strong></strong>' . ( $field['append'] ? ' ' . $field['append'] : '' ) . '</span>';
		$e .= '<input type="number"';
